defmodule IexCode.Repo.Migrations.AddEditorialUiTheme do
  use Ecto.Migration
  ...
  @editorial_ui_theme """
    , "ui_theme" TEXT DEFAULT 'obsidian' NOT NULL
        ...
        CHECK (ui_theme IN ('obsidian', 'midnight', 'graphite', 'aurora', 'porcelain', 'sandstone', 'editorial'))
  """
  ...
  def up do
    rebuild(
      "app_settings_editorial",
      @base_columns <> @editorial_ui_theme <> @tail_columns <> @checks
    )
  end

  def down do
    execute("UPDATE app_settings SET ui_theme = 'obsidian' WHERE ui_theme = 'editorial'")
